...
"use strict";
eval("\n\n__webpack_require__(/*! ./second.pug */ \"./src/second.pug\");\n\n__webpack_require__(/*! ./second.scss */ \"./src/second.scss\");\n\nconsole.log('hi, im second');\n\n//# sourceURL=webpack:///./src/second.js?");
...
eval("var pug = __webpack_require__(/*! ../node_modules/pug-runtime/index.js */ \"./node_modules/pug-runtime/index.js\");\n\nfunction template(locals) {var pug_html = \"\", pug_mixins = {}, pug_interp;var pug_indent = [];\npug_html = pug_html + \"\\u003C!DOCTYPE html\\u003E\\n\\u003Chtml lang=\\\"ru\\\"\\u003E\\n  \\u003Chead\\u003E\\n    \\u003Cmeta charset=\\\"UTF-8\\\"\\u003E\\n    \\u003Ctitle\\u003EUI-Kit\\u003C\\u002Ftitle\\u003E\\n  \\u003C\\u002Fhead\\u003E\\n  \\u003Cbody\\u003E\\u003Ca class=\\\"label-CTA\\\" href=\\\"index.html\\\"\\u003EВернуться на главную\\u003C\\u002Fa\\u003E\\u003Cbr\\u003E\\u003Cbr\\u003E\";\npug_mixins[\"TextInput\"] = pug_interp = function(inputText, addClasses){\nvar block = (this && this.block), attributes = (this && this.attributes) || {};\npug_html = pug_html + \"\\n    \";\npug_html = pug_html + pug_indent.join(\"\");\npug_html = pug_html + \"\\u003Cinput\" + (pug.attr(\"class\", pug.classes([\"input input_type_text \" + addClasses], [true]), false, true)+\" type=\\\"text\\\"\"+pug.attr(\"placeholder\", inputText, true, true)) + \"\\u003E\";\n};\npug_mixins[\"TextField\"] = pug_interp = function(labelText, inputText){\nvar block = (this && this.block), attributes = (this && this.attributes) || {};\npug_html = pug_html + \"\\n    \";\npug_html = pug_html + pug_indent.join(\"\");\npug_html = pug_html + \"\\u003Cdiv class=\\\"textField\\\"\\u003E\\n      \";\npug_html = pug_html + pug_indent.join(\"\");\npug_html = pug_html + \"\\u003Clabel class=\\\"label-CTA textField__title\\\"\\u003E\" + (pug.escape(null == (pug_interp = labelText) ? \"\" : pug_interp)) + \"\\u003Cbr\\u003E\";\npug_indent.push('        ');\npug_mixins[\"TextInput\"](inputText, \"textField__input\");\npug_indent.pop();\npug_html = pug_html + \"\\n      \";\npug_html = pug_html + pug_indent.join(\"\");\npug_html = pug_html + \"\\u003C\\u002Flabel\\u003E\\n    \";\npug_html = pug_html + pug_indent.join(\"\");\npug_html = pug_html + \"\\u003C\\u002Fdiv\\u003E\";\n};\npug_mixins[\"MaskedTextInput\"] = pug_interp = function(inputText, addClasses, mask){\nvar block = (this && this.block), attributes = (this && this.attributes) || {};\npug_html = pug_html + \"\\n    \";\npug_html = pug_html + pug_indent.join(\"\");\npug_html = pug_html + \"\\u003Cinput\" + (pug.attr(\"class\", pug.classes([\"input input_type_text \" + addClasses], [true]), false, true)+\" type=\\\"text\\\"\"+pug.attr(\"placeholder\", inputText, true, true)+pug.attr(\"pattern\", mask, true, true)) + \"\\u003E\";\n};\npug_mixins[\"MaskedTextField\"] = pug_interp = function(labelText, inputText){\nvar block = (this && this.block), attributes = (this && this.attributes) || {};\npug_html = pug_html + \"\\n    \";\npug_html = pug_html + pug_indent.join(\"\");\npug_html = pug_html + \"\\u003Cdiv class=\\\"textField_masked\\\"\\u003E\\n      \";\npug_html = pug_html + pug_indent.join(\"\");\npug_html = pug_html + \"\\u003Clabel class=\\\"label-CTA textField__title textField_masked__title\\\"\\u003E\" + (pug.escape(null == (pug_interp = labelText) ? \"\" : pug_interp)) + \"\\u003Cbr\\u003E\";\npug_indent.push('        ');\npug_mixins[\"MaskedTextInput\"](inputText, \"textField__input textField_masked__input\");\npug_indent.pop();\npug_html = pug_html + \"\\n      \";\npug_html = pug_html + pug_indent.join(\"\");\npug_html = pug_html + \"\\u003C\\u002Flabel\\u003E\\n    \";\npug_html = pug_html + pug_indent.join(\"\");\npug_html = pug_html + \"\\u003C\\u002Fdiv\\u003E\";\n};\npug_indent.push('    ');\npug_mixins[\"TextField\"](\"Text Field\", \"This is pretty awesome\");\npug_indent.pop();\npug_indent.push('    ');\npug_mixins[\"MaskedTextField\"].call({\nblock: function(){\npug_html = pug_html + \"\\n\";\npug_html = pug_html + pug_indent.join(\"\");\npug_html = pug_html + \"\\u003C!--+Button('not example')--\\u003E\";\n}\n}, \"Masked Text Field\", \"ДД.ММ.ГГГГ\");\npug_indent.pop();\npug_html = pug_html + \"\\n  \\u003C\\u002Fbody\\u003E\\n\\u003C\\u002Fhtml\\u003E\";;return pug_html;};\nmodule.exports = template;\n\n//# sourceURL=webpack:///./src/second.pug?");
