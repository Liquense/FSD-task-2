...
/***/ "./src/site-pages/room-details sync recursive \\.(js|scss)$":
/*!*******************************************************!*\
  !*** ./src/site-pages/room-details sync \.(js|scss)$ ***!
  \*******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("var map = {\n\t\"./room-details.js\": \"./src/site-pages/room-details/room-details.js\",\n\t\"./room-details.scss\": \"./src/site-pages/room-details/room-details.scss\"\n};\n\n\nfunction webpackContext(req) {\n\tvar id = webpackContextResolve(req);\n\treturn __webpack_require__(id);\n}\nfunction webpackContextResolve(req) {\n\tif(!__webpack_require__.o(map, req)) {\n\t\tvar e = new Error(\"Cannot find module '\" + req + \"'\");\n\t\te.code = 'MODULE_NOT_FOUND';\n\t\tthrow e;\n\t}\n\treturn map[req];\n}\nwebpackContext.keys = function webpackContextKeys() {\n\treturn Object.keys(map);\n};\nwebpackContext.resolve = webpackContextResolve;\nmodule.exports = webpackContext;\nwebpackContext.id = \"./src/site-pages/room-details sync recursive \\\\.(js|scss)$\";\n\n//# sourceURL=webpack:///./src/site-pages/room-details_sync_\\.(js%7Cscss)$?");
...
"use strict";
eval("\n\nvar _index = __webpack_require__(/*! ../../index */ \"./src/index.js\");\n\nvar _init = _interopRequireDefault(__webpack_require__(/*! ../../blocks/donut-chart/init */ \"./src/blocks/donut-chart/init.js\"));\n\nvar _init2 = _interopRequireDefault(__webpack_require__(/*! ../../cards/booking-card/init */ \"./src/cards/booking-card/init.js\"));\n\nvar _init3 = _interopRequireDefault(__webpack_require__(/*! ../../blocks/comment/init */ \"./src/blocks/comment/init.js\"));\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { \"default\": obj }; }\n\n/* eslint-disable no-undef */\n// jquery импортирована вебпаком\n(0, _index.importCommon)();\n(0, _index.importContext)(__webpack_require__(\"./src/site-pages/room-details sync recursive \\\\.(js|scss)$\"));\nvar donutParams = {\n  data: [{\n    caption: 'Великолепно',\n    value: 520,\n    firstColor: '#FFE39C',\n    secondColor: '#FFBA9C'\n  }, {\n    caption: 'Хорошо',\n    value: 260,\n    firstColor: '#6FCF97',\n    secondColor: '#66D2EA'\n  }, {\n    caption: 'Удовлетворительно',\n    value: 260,\n    firstColor: '#BC9CFF',\n    secondColor: '#8BA4F9',\n    isActive: true\n  }, {\n    caption: 'Разочарован',\n    value: 0,\n    firstColor: '#919191',\n    secondColor: '#3D4975'\n  }],\n  defaultStyle: {\n    outerRadius: 120,\n    innerRadius: 116\n  },\n  activeStyle: {\n    outerRadius: 120,\n    innerRadius: 110\n  },\n  arcsGap: 2\n};\n(0, _init[\"default\"])(document.body, donutParams);\n(0, _init2[\"default\"])();\n(0, _init3[\"default\"])();\n\n//# sourceURL=webpack:///./src/site-pages/room-details/room-details.js?");
